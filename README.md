...
We also did some work tracking the ripple effects some of the work done during the ActEarly project. An image of the full map is below, and there is a reasonable version of an interactive map available [here](https://prgarnett.github.io/ActEarly/ripple_effects_map.html).
